...
import { ProducerRepository, CultureFarmRepository, FarmRepository  } from "@/infra/db";
...
export const makeAddProducerController = (): Controller => {
  ...
  const addProducerUseCase = new AddProducerUseCase(producerRepository, farmRepository, cultureFarmRepository);
